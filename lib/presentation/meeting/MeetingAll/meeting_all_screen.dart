...
class MeetingAllScreen extends GetView<MeetingAllContoroller> {
        ...
        return NotificationListener<ScrollNotification>(
          ...
          child: CustomListView(
            ...
            itemBuilder: (context, index, item) {
              ...
              return _buildMeetingTile(allListVisit, controller, context);
            },
          ),
        );
      }),
  ...
  Widget _buildMeetingTile(MeetingList allListVisit, MeetingAllContoroller controller, BuildContext context) {
        ...
        showModalBottomSheet(
          ...
          builder: (context) {
            return buildBottomSheet(
              ...
              statusColor: controller.getStatusColor(allListVisit.visitStatus),
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: controller.getStatusColor(allListVisit.visitStatus).withAlpha(40),
                ),
                child: Center(
                  child: Text(
