  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.hasError.value && controller.approvedMeeting.isEmpty) {
          return Center(
            child: Column(
        ...
        if (controller.approvedMeeting.isEmpty) {
        ...
        return NotificationListener<ScrollNotification>(
          ...
          child: CustomListView(
            itemCount: controller.approvedMeeting.length,
            itemBuilder: (context, index, item) {
              final allListVisit = controller.approvedMeeting[index];
