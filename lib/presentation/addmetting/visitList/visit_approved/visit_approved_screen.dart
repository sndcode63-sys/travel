...
class VisitApprovedScreen extends StatelessWidget {
  const VisitApprovedScreen({super.key});
      ...
      body: Obx(() {
        ...
        return CustomListView(
          ...
          itemBuilder: (context, index, item) {
            final VisitApproved = controller.pendingMeetingList[index];
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: CachedNetworkImage(
                                imageUrl:
                                "${VisitApproved.fullImageUrl}${VisitApproved.photo}",
                                height: 320.h,
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "${VisitApproved.visitDate}${VisitApproved.submitTime}",
                                      style: TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: CachedNetworkImage(
                        imageUrl: "${VisitApproved.fullImageUrl}${VisitApproved.photo}",
                        fit: BoxFit.cover,
                        placeholder:
                            (context, url) => const Center(
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 2.h),
                          Text(
                            "Project: ${VisitApproved.schemeName ?? "N/A"}",
                            style: TextStyle(fontSize: 13.sp, color: UColors.primary),
                          ),
                          SizedBox(height: 2.h),
                          Text(
                            "Visit Date: ${VisitApproved.visitDate ?? ""} ${VisitApproved.submitTime}",
                            style: TextStyle(
                              fontSize: 12.sp,
