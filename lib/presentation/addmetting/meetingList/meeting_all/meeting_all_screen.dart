...
class MeetingAllScreen extends GetView<MeetingAllController> {
  const MeetingAllScreen({super.key});
  @override
  Widget build(BuildContext context) {
    final MeetingAllController controller = Get.put(MeetingAllController());
    return Scaffold(
      body: Obx(() {
        ...
        return Obx(() {
          return CustomListView(
            itemCount: controller.allMeetingList.length,
            isMoreDataAvailable: controller.isMoreDataAvailable.value,
            onEndReached: () => controller.fetchUsers(),
            ...
            itemBuilder: (context, index, item) {
              ...
              print("iiiii------jjjjj");
              print("iiiii------jjjjj");
              print(controller.allMeetingList.length);
              print("iiiii------jjjjj");
              print("iiiii------jjjjj");
              print("iiiii------jjjjj");
              print("iiiii------jjjjj");
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Submit Date: ${allListVisit.visitDate ?? ""}",
                          style: const TextStyle(
                            color: UColors.grey,
                            fontSize: 10,
                            fontWeight: FontWeight.w400,
