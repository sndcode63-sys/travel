...
import 'approved_controller.dart';

class ApprovedVehicleScreen extends GetView<ApprovedController> {
  const ApprovedVehicleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final ApprovedController controller = Get.put(ApprovedController());
...
class AnimatedVehicleCard extends StatefulWidget {
  ...
  final ApprovedController controller;
  final int index;
