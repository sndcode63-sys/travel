    ...
    try {
      ...
      if (response.isEmpty) {
        ...
        final approvedList = response
            .where((item) => item.visitStatus?.toLowerCase() == "pending")
            .toList();
...
extension VehicleControllerDelete on PendingController {
...
extension VehicleControllerUpdate on PendingController {
...
// PendingController.dart

extension PendingFiltering on PendingController {
