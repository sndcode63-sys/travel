...
class PendingVehicleScreen extends GetView<PendingController> {
  const PendingVehicleScreen({super.key});
...
class AnimatedVehicleCard extends StatefulWidget {
  ...
  final PendingController controller;
  final int index;
