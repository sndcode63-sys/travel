...
class RejectedVController extends GetxController {
    ...
    try {
      ...
      if (response.isEmpty) {
        ...
        final approvedList = response
            .where((item) => item.visitStatus?.toLowerCase() == "rejected")
            .toList();
...
extension VehicleControllerDelete on RejectedVController {
...
extension VehicleControllerUpdate on RejectedVController {
...
extension RejectedFiltering on RejectedVController {
