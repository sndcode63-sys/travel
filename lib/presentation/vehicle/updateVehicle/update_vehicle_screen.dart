...
import 'package:travell_booking_app/presentation/vehicle/updateVehicle/update_vehicle_controller.dart';
...
class UpdateVehicleScreen extends GetView<UpdateVehicleController> {
  const UpdateVehicleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final UpdateVehicleController controller = Get.put(UpdateVehicleController());
