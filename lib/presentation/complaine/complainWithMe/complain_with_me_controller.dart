...
import 'complain_with_me_repository.dart';

class ComplainWithMeController extends GetxController {
  RxBool isLoading = false.obs;
  RxBool hasData = false.obs;

  RxList<Data> disputeList = <Data>[].obs;

  final ComplainWithMeRepository _repository = ComplainWithMeRepository();
