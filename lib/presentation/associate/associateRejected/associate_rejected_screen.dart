...
import 'associate_rejected_controller.dart';

class AssociateRejectedScreen extends StatelessWidget {
  AssociateRejectedScreen({super.key});
  final controller = Get.put(AssociateRejectedController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.rejectedAssociateList.isEmpty) {
          return const Center(child: Text("No associates found"));
        }
        return CustomListView(
          itemCount: controller.rejectedAssociateList.length,
          itemBuilder: (context, index, item) {
            final associateList = controller.rejectedAssociateList[index];
            return Container(
