...
class AddAssociateScreen extends StatelessWidget {
  AddAssociateScreen({super.key});
  final AddAssociateController controller = Get.put(
                ...
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          isEdit ? "Edit Associate" : "Associate",
                          style: TextStyle(
                            fontSize: 18.sp,
