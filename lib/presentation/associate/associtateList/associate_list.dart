...
import 'package:travell_booking_app/presentation/allAssociate/all_associate_screen.dart';
...
class AssociateList extends StatelessWidget {
   AssociateList({super.key});
  final controller = Get.put(AssociateListController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.allAssociateList.isEmpty) {
          return const Center(child: Text("No associates found"));
        }
        return CustomListView(
          itemCount: controller.allAssociateList.length,
          itemBuilder: (context, index, item) {
            final associateList = controller.allAssociateList[index];
            return Container(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: controller
                              .getStatusColor(associateList.active)
                              .withOpacity(0.15),
