...
class AssociateVerificationDocScreen extends StatelessWidget {
  final AssociateVerificationDocController controller = Get.put(AssociateVerificationDocController());

  AssociateVerificationDocScreen({super.key});
...
class FilePickerWidget extends StatelessWidget {
  ...
  final AssociateVerificationDocController controller;
