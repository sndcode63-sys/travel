...
import '../../../models/associate/associate_verificatio_model.dart';


class AssociateRepositoryDocumentsVerification {
  static final _apiServices = ApiServices();

  static Future<AssociateVerificatioModel> associateUploadDocuments({
    ...
    return await _apiServices.post<AssociateVerificatioModel>(
      ApiConstants1.saveAssociateData,
          (json) => AssociateVerificatioModel.fromJson(json),
      data: {
