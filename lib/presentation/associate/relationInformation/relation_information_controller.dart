...
class AssociateRelationInformationController extends GetxController {
  ...
  Future<void> fetchMasterList() async {
    try {
      ...
      masterData.value = await AssociateRelationRepository().getSefList();
  ...
  Future<void> updateRelationInfo() async {
    ...
    try {
      final response = await AssociateRelationRepository.updateRelationInfo(
      ...
      if (response.status == 200) {
        ...
        Future.delayed(const Duration(seconds: 2), () {
          ...
          Get.offAllNamed(
            AppRoutes.associateVerification,
