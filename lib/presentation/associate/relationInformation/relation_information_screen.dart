...
class AssociateRelationInformationScreen extends StatelessWidget {
  const AssociateRelationInformationScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    print("-----------------");
    print("-----------------");
    final controller = Get.put(AssociateRelationInformationController());
