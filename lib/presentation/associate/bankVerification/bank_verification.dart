...
class AssociateBankVerification extends StatelessWidget {
  AssociateBankVerification({super.key});

  final controller = Get.put(AssociateBankVerificationController());
