...
import '../associtateList/associate_list_controller.dart';
import 'associate_approved_controller.dart';

class AssociateApprovedScreen extends StatelessWidget {
  AssociateApprovedScreen({super.key});
  final controller = Get.put(AssociateApprovedController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (controller.approvedAssociateList.isEmpty) {
          return const Center(child: Text("No associates found"));
        }
        return CustomListView(
          itemCount: controller.approvedAssociateList.length,
          itemBuilder: (context, index, item) {
            final associateList = controller.approvedAssociateList[index];
            return Container(
